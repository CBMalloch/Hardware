...
<part name="JP5" library="SparkFun-Connectors" deviceset="M04" device="LOCK_LONGPADS"/>
...
<part name="." library="linear" deviceset="MCP1703" device="DB" value="MCP1825S"/>
...
<sheet>
<plain>
<text x="220.98" y="-38.1" size="2.54" layer="94" font="vector">v2.0.1</text>
<text x="134.62" y="-20.32" size="2.54" layer="94" font="vector">Creator: Charles B. Malloch, PhD
Released to the public domain.</text>
<text x="27.94" y="106.68" size="1.778" layer="94"> 1 - GND
 2 - PWR 5VDC
 3 - D0 / RXD
 4 - D1 / TXD</text>
<text x="177.8" y="53.34" size="1.778" layer="94">ESP8266
1 - TX
2 - GND
3 - CH_PD
4 - GPI2
...
7 - Vcc
8 - RX</text>
<text x="40.64" y="58.42" size="1.778" layer="94">3V3</text>
<text x="63.5" y="124.46" size="1.778" layer="94" rot="MR0">5V</text>
<text x="58.42" y="116.84" size="1.778" layer="94">3V3</text>
<text x="5.08" y="81.28" size="1.778" layer="94">5V</text>
<text x="25.4" y="-10.16" size="1.778" layer="94">I think this (v1) is WRONG!!!
The 5V pullups need to be 
on the PC side ( JP5) 
and the 3V3 pullups need to be 
on the ESP-01 side ( JP7 ).
They WERE wrong.

v2.0.0 fixed this. Built 3, I think.
v2.0.1 replaces through-hole resistors and caps with 1206 SMD</text>
<text x="162.56" y="91.44" size="1.778" layer="94">1 - IO1 / TXD0 / CS1
3 - CH_PD : H = enable, L = power down
4 - IO2 / TXD1
5 - ~RST
6 - IO0 / CS2 : at reset, H = run, L = flash
8 - RXD0</text>
<text x="129.54" y="20.32" size="1.778" layer="94">Warning! pinout diagrams show swapped pin numbering, so pin 1 &lt;-&gt; 2, 3 &lt;-&gt; 4, etc.</text>
</plain>
<instances>
<instance part="FRAME1" gate="G$1" x="-15.24" y="-45.72"/>
<instance part="FRAME1" gate="G$2" x="132.08" y="-45.72"/>
<instance part="JP5" gate="G$1" x="17.78" y="119.38" rot="R270"/>
<instance part="JP7" gate="A" x="157.48" y="43.18"/>
<instance part="GND12" gate="1" x="185.42" y="40.64"/>
<instance part="R1" gate="G$1" x="106.68" y="27.94" rot="R180"/>
<instance part="R2" gate="G$1" x="106.68" y="35.56" rot="R180"/>
<instance part="R7" gate="G$1" x="106.68" y="45.72" rot="R180"/>
<instance part="R8" gate="G$1" x="106.68" y="53.34" rot="R180"/>
<instance part="GND1" gate="1" x="-5.08" y="106.68"/>
<instance part="." gate="G$1" x="20.32" y="60.96"/>
<instance part="GND2" gate="1" x="20.32" y="43.18"/>
<instance part="Q1" gate="G$1" x="78.74" y="88.9" rot="MR270"/>
<instance part="Q2" gate="G$1" x="129.54" y="88.9" rot="MR270"/>
<instance part="R3" gate="G$1" x="88.9" y="109.22" rot="MR270"/>
<instance part="R4" gate="G$1" x="68.58" y="109.22" rot="MR270"/>
<instance part="R5" gate="G$1" x="139.7" y="109.22" rot="MR270"/>
<instance part="R6" gate="G$1" x="119.38" y="109.22" rot="MR270"/>
...
<wire x1="162.56" y1="48.26" x2="185.42" y2="48.26" width="0.1524" layer="91"/>
...
<wire x1="175.26" y1="35.56" x2="111.76" y2="35.56" width="0.1524" layer="91"/>
...
<wire x1="68.58" y1="121.92" x2="119.38" y2="121.92" width="0.1524" layer="91"/>
...
<wire x1="99.06" y1="40.64" x2="154.94" y2="40.64" width="0.1524" layer="91"/>
...
<wire x1="55.88" y1="60.96" x2="55.88" y2="119.38" width="0.1524" layer="91"/>
...
<wire x1="22.86" y1="88.9" x2="68.58" y2="88.9" width="0.1524" layer="91"/>
...
<wire x1="88.9" y1="66.04" x2="172.72" y2="66.04" width="0.1524" layer="91"/>
...
<wire x1="139.7" y1="88.9" x2="139.7" y2="48.26" width="0.1524" layer="91"/>
...
<errors>
<approved hash="113,1,109.116,46.886,FRAME1,,,,,"/>
<approved hash="113,1,20.6096,117.517,JP5,,,,,"/>
<approved hash="113,1,158.708,45.9461,JP7,,,,,"/>
</errors>
</schematic>
</drawing>
<compatibility>
